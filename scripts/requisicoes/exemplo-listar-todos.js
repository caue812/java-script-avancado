...
async function apagar(evento) {
    ...
    //Utilizaremos o evento para saber qual o botão que ocorre o clique
    ...
    Swal.fire({
        ...
        text:" Você não poderá reverte isso!",
        icon: "warning",
...
async function consultarEmpresas() {
    ...
    empresas.forEach(empresa => {
        ...
        <button class="btn btn-danger botao-apagar" data-id="${empresa.id}" 
